...
const commentViewController = new CommentViewController(new CommentServiceImpl(new MongooseCommentRepository(), new MongooseUserRepository(), new MongoosePostRepository()));

commentViewRouter.get(extractPath(CATEGORY_VIEW_ROUTES.CATEGORY_LIST, ROUTES_INDEX.CATEGORY_VIEW), commentViewController.commentListPage);

commentViewRouter.get(extractPath(CATEGORY_VIEW_ROUTES.CATEGORY_DETAIL, ROUTES_INDEX.CATEGORY_VIEW), commentViewController.commentDetailPage);
