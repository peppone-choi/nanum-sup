...
adminCategoryRouter.get(extractPath(ADMIN_CATEGORY_ROUTES.GET_CATEGORY, ROUTES_INDEX.ADMIN_CATEGORY_API), authUserMiddleware, validate(adminGetCategoryValidator), adminCategoryController.getCategory);

adminCategoryRouter.get(
  extractPath(ADMIN_CATEGORY_ROUTES.GET_CATEGORY_DETAIL, ROUTES_INDEX.ADMIN_CATEGORY_API),
  authUserMiddleware,
...
adminCategoryRouter.post(
  extractPath(ADMIN_CATEGORY_ROUTES.CREATE_CATEGORY, ROUTES_INDEX.ADMIN_CATEGORY_API),
  authUserMiddleware,
...
adminCategoryRouter.put(
  extractPath(ADMIN_CATEGORY_ROUTES.UPDATE_CATEGORY, ROUTES_INDEX.ADMIN_CATEGORY_API),
  authUserMiddleware,
...
adminCategoryRouter.delete(
  extractPath(ADMIN_CATEGORY_ROUTES.DELETE_CATEGORY, ROUTES_INDEX.ADMIN_CATEGORY_API),
  authUserMiddleware,
