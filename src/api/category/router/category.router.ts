...
import { getCategoryDetailValidator, getCategoryValidator } from "../dto/validation/category.validation";
...
categoryRouter.get(extractPath(CATEGORY_ROUTES.GET_CATEGORY, ROUTES_INDEX.CATEGORY_API), authUserMiddleware, validate(getCategoryValidator), categoryController.getCategory);

categoryRouter.get(extractPath(CATEGORY_ROUTES.GET_CATEGORY_DETAIL, ROUTES_INDEX.CATEGORY_API), authUserMiddleware, validate(getCategoryDetailValidator), categoryController.getCategoryDetail);
