...
const adminUserViewController = new AdminUserViewController(
...
adminUserViewRouter.get(
  extractPath(ADMIN_USER_VIEW_ROUTES.USER_ADD, ROUTES_INDEX.ADMIN_USER_VIEW),
  adminUserViewController.userAddPage
);

adminUserViewRouter.get(
  extractPath(ADMIN_USER_VIEW_ROUTES.USER_EDIT, ROUTES_INDEX.ADMIN_USER_VIEW),
  adminUserViewController.userEditPage
);

adminUserViewRouter.get(
  extractPath(ADMIN_USER_VIEW_ROUTES.USER_DETAIL, ROUTES_INDEX.ADMIN_USER_VIEW),
  adminUserViewController.userDetailPage
);
