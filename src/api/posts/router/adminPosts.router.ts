...
import { adminCreatePostValidator, adminDeletePostValidator, adminGetPostDetailValidator, adminGetPostsValidator, adminUpdatePostValidator } from "@/api/posts/dto/validations/adminPost.validation";
...
adminPostRouter.post(extractPath(ADMIN_POST_ROUTES.CREATE_DUMMY, ROUTES_INDEX.ADMIN_POSTS_API), adminPostsController.createDummy);
adminPostRouter.post(extractPath(ADMIN_POST_ROUTES.CREATE_POST, ROUTES_INDEX.ADMIN_POSTS_API), validate(adminCreatePostValidator), authUserMiddleware, adminPostsController.createPost);
adminPostRouter.put(extractPath(ADMIN_POST_ROUTES.UPDATE_POST, ROUTES_INDEX.ADMIN_POSTS_API), validate(adminUpdatePostValidator), adminPostsController.updatePost);
adminPostRouter.delete(extractPath(ADMIN_POST_ROUTES.DELETE_POST, ROUTES_INDEX.ADMIN_POSTS_API), validate(adminDeletePostValidator), adminPostsController.deletePost);
